            ...
            @foreach($prods as $item)
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{ route('product_details', $item->slug) }}" title="{{ $item->name }}">
                            <figure><img src="{{ asset('images') . '/' . $item->photo }}" style="width:800px; height:auto;" alt="{{ $item->name }}"></figure>
                        </a>
                    ...
                    <div class="product-info">
                        <a href="{{ route('product_details', $item->slug) }}" class="product-name"><span>{{ $item->name }}</span></a>
